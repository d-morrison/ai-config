---
name: "pm"
description: "Codex wrapper for the ai-config Claude skill `pm`. Alias for `prompt-me`. Restate every open question still waiting on user input as a single, clearly numbered list. Use when asked to 'pm', 'prompt me', 'what are you waiting on me for', or '/pm'. Use when Codex is asked to use `pm`, `/pm`, or the corresponding ai-config/Claude skill workflow."
---
