...
- When a memory, skill, or doc entry points at a location in *another* file, don't cite
  ...
  `## Foo` heading) or use a vaguer reference instead. Same root as the inline-R-expressions
  rule above: don't bake a volatile value into prose. (ai-config#135 review: a
