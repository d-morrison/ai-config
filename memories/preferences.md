...
- The `<!-- Shared with the lab manual -->` comment is aspirational, not a
  ...
  `lab-manual`'s matching `.qmd` chapter before asserting it is. On PR #336,
  ...
  gap survived because the tracking issue (lab-manual#328) was closed
  ...
  instead (lab-manual#377) and note it in the PR thread. Also: before closing
